...
# urlparse does NOT percent-decode the userinfo section, so any
# encoded characters in the username/password (e.g. %40 for '@')
# were being passed through literally, producing the wrong
# credentials and "password authentication failed" errors.
